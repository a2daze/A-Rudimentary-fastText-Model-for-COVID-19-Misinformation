...
#Read in data
disinformation <- read.csv('/Users/alexz/Programming/Python Projects/Sentiment Analysis of COVID-19 Misinformation with FastText/Sentiment-Analysis-of-COVID-19-Misinformation-with-FastText/disinfo_stories.csv')

```

```{r}
#Count number of URLs in the data 
nrow(disinformation)
```
...
#print total number of word in the file
...
count_words("/Users/alexz/Programming/Python Projects/Sentiment Analysis of COVID-19 Misinformation with FastText/Sentiment-Analysis-of-COVID-19-Misinformation-with-FastText/full_text_disinfo_cleaned.txt")
```

```{r}
count_characters("/Users/alexz/Programming/Python Projects/Sentiment Analysis of COVID-19 Misinformation with FastText/Sentiment-Analysis-of-COVID-19-Misinformation-with-FastText/full_text_disinfo_cleaned.txt")
```
